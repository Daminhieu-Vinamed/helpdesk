$(document).ready(function () {
    ...
    $(document).on('click', '.change-password-client', function () {
        const passwordBefore = $('input[name="passwordBefore"]').val();
        const passwordAfter = $('input[name="passwordAfter"]').val();
        const againPasswordAfter = $('input[name="againPasswordAfter"]').val();
        $.ajax({
